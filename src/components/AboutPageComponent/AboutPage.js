...
//           >
//             <img
//               className='imageonAboutUsPage'
//               src={cfo}
//               alt="Card background"
//               style={{ zIndex: 1, width: '100%', height: '100%', objectFit: 'cover', cursor: 'pointer' }}
//             />
//             <button
//                 className='buttononAboutUsPageCeo'
//                 style={{
//                 cursor: 'pointer',
//                 position: 'absolute',
//                 top: '50%',
...
//             >
//               <p>
//                 <FaBars /> This is Denis our CEO! He works hard in his room and is Greek.
//               </p>
//             </button>
//           </div>
//           <div style={{ position: 'relative', width: '560px', height: '478px', borderRadius: '5px', overflow: 'hidden' }}>
//             <img className='imageonAboutUsPage' src={cfo} alt="Card background"  style={{ zIndex: 1, width: '100%', height: '100%', objectFit: 'cover', cursor: 'pointer' }}/>
//             <button
//                 className='buttononAboutUsPageCeo'
//                 style={{
//                 cursor: 'pointer',
...
//             </button>                </div>
//             <div style={{ position: 'relative', width: '560px', height: '478px', borderRadius: '5px', overflow: 'hidden' }}>
//               <img  className='imageonAboutUsPage' src={marketing} alt="Card background"  style={{ zIndex: 1, width: '100%', height: '100%', objectFit: 'cover', cursor: 'pointer' }}/>
//               <button
//                 className='buttononAboutUsPageCeo'
//                 style={{
//                 cursor: 'pointer',
